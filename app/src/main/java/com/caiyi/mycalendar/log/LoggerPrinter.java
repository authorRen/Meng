package com.caiyi.mycalendar.log;
...
final class LoggerPrinter implements Printer {
    ...
    private static final boolean LEO_DEBUG = false;
    ...
    public synchronized void log(int priority, String tag, String message, Throwable throwable) {
        ...
        if (throwable != null) {
            logContent += Helper.getStackTraceString(throwable);
        }
        if (Helper.isEmpty(logContent)) {
            logContent += "No message/exception is set";
        }
        ...
        if (length <= CHUNK_SIZE) {
            ...
            logContent(priority, tag, logContent);
